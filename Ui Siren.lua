...
if not isfolder("Siren X") then
    makefolder("Siren X")
end
if not isfolder("Siren X/Config") then
    makefolder("Siren X/Config")
end
...
local ConfigFile = "Siren X/Config/Siren_" .. gameName .. ".json"
...
function Sirenx:MakeNotify(NotifyConfig)
    ...
    NotifyConfig.Title = NotifyConfig.Title or "Siren X"
...
function Sirenx:Window(GuiConfig)
    ...
    GuiConfig.Title        = GuiConfig.Title or "Siren X"
